        ...
        {activeTab === 'profile' && (
            <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="text-gray-600 dark:text-gray-400">회사명</div>
                                ...
                                <div className="flex justify-between items-center mb-4">
                                  <div className="flex items-center gap-3">
                                    ...
                                    <span className={`px-2 py-1 rounded-full text-sm ${
                                        quote.status === 'ADOPT' || quote.status === 'Adopt'
                  ...
                  <div className="space-y-8">
                    {writtenQuotes.length === 0 ? (
                        ...
                        writtenQuotes.map(quote => {
                          console.log('작성한 견적 데이터:', quote);
                          const requestStatus = quote.estimateRequest?.status || quote.status || 'WAIT';
                              ...
                              <div key={quote.id} className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm">
                                <div className="flex justify-between items-center mb-4">
                                  <div className="flex items-center gap-3">
                                    ...
                                    <span className={`px-2 py-1 rounded-full text-sm ${
                                        requestStatus === 'ADOPT' || requestStatus === 'Adopt'
                                            ? 'bg-green-900 text-green-200'
                                            : requestStatus === 'WAIT' || requestStatus === 'Wait'
                                                ? 'bg-blue-900 text-blue-200'
                                                : 'bg-gray-700 text-gray-200'
                                    }`}>
                            {requestStatus === 'ADOPT' || requestStatus === 'Adopt'
