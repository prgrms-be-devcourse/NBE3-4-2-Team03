...
-- 견적 요청 데이터 삽입
INSERT INTO estimate_request (purpose, budget, other_request, create_date)
VALUES ('게임용', 2000000, '고사양 게임이 잘 돌아갔으면 좋겠습니다', '2024-03-20 10:30:00');
INSERT INTO estimate_request (purpose, budget, other_request, create_date)
VALUES ('사무용', 1000000, '문서 작업이 주 용도입니다', '2024-03-20 11:30:00');
INSERT INTO estimate_request (purpose, budget, other_request, create_date)
VALUES ('영상편집용', 3000000, '4K 영상 편집을 주로 합니다', '2024-03-20 14:30:00');
